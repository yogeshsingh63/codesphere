              ...
              <Row className="mt-5">
                ...
                <Col lg="7" md="13">
                  ...
                  <h5 className="description text-right text-dark">
                    CodeSphere has support for teachers and content-creators to add custom courses & challenges that can be shared with their students. Using our built-in markdown editor and course creator, producting a coding curriculum is incredibly easy!
                  </h5>
                </Col>
              </Row>
            </Container>
